# Loompay Documentation

**Welcome to LoomPay—the next evolution of digital banking!**
...
- [Wallet Functionality](wallet-functionality.md)
- [Technical Architecture](technical-architecture.md)
- [Secured Credit Card System](secured-credit-card.md)
- [Staking and Liquidity Options](staking-liquidity.md)
- [Cashback Reward Structure](cashback-rewards.md)
- [Referral Program Guidelines](referral-program.md)
